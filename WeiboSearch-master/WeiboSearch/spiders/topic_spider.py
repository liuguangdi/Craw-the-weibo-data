...
class WeiboSpiderSpider(scrapy.Spider):
    ...
    def start_requests(self):
        '''
        https://weibo.cn/search/mblog?hideSearchFrame=&keyword=武汉，肺炎&advancedfilter=1&starttime=20191220&endtime=20191230&sort=hot
        keyword, starttime, endtime, sort：hot/time
        '''
        url_format = "https://weibo.cn/search/mblog?hideSearchFrame=&keyword={}&advancedfilter=1&starttime={}&endtime={}&sort=hot"
